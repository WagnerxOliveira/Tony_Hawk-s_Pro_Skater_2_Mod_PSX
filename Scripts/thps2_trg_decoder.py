...
def decodificar_gatilhos_trg():
    ...
    pasta_origem = os.path.join(pasta_base, "Gatilhos_TRG")
    # Criando o diretório de destino compatível
    pasta_destino = os.path.join(pasta_base, "Gatilhos_TXT_Decodificados")
